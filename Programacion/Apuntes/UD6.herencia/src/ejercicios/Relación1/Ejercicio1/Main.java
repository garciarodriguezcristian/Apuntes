...
// - Crea una clase `Electrodomestico` con los atributos `marca` y `modelo`. Luego, crea dos subclases: `Lavadora` con el atributo `capacidadCarga` y `Televisor` 
// con el atributo `tamañoPantalla`.  
