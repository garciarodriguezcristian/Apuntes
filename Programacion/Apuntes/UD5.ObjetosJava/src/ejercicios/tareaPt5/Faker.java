...
public class Faker {
    ...
    // =========================================================
    /**
     * Genera un nombre de animal simple. Ej: "Tigre Asiático"
     */
    ...
    /**
     * Genera un código alfanumérico de 6 caracteres (A-Z, 0-9). Ej: "A1B2C3"
     */
    ...
    /**
     * Genera una cantidad aleatoria para el animal. Rango recomendado: 0 a 50
     * (puedes ajustarlo en Main si quieres).
     */
    ...
    /**
     * Genera un precio aleatorio para el animal (2 decimales). Rango
     * recomendado: 5.00 a 200.00
     */
