...
public class Faker {
    ...
    /**
     * Genera un DNI español simple (8 dígitos + letra). No hace validación real
     * de la letra: se genera aleatoria.
     */
    ...
    /**
     * Devuelve una fecha simple como String "2026-02-17" en un rango. (No
     * valida calendarios reales: solo formato y rango aproximado.)
     */
