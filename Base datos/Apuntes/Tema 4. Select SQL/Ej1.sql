...
select * from empleados where salario > 3000 && salario <= 6000;
...
select nombre, departamento from empleados where departamento = "marketing" or departamento = "ventas" and salario > 5000;
...
select departamento from empleados where edad < 30 && salario > 4000;

-- 10. recupera los empleados que tienen un salario mayor o igual a 3500 y están en el departamento desarrollo.
select * from empleados where salario >= 3500 && departamento = "desarrollo";